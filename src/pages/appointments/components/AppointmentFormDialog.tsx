...
export const AppointmentFormDialog = memo(function AppointmentFormDialog({
  ...
  const { form, state, data, actions, watched } = useAppointmentForm({
    storeId,
    appointment,
    open,
    onClose,
  ...
  // Defer heavy form body mount so the dialog animation starts smoothly
  ...
  useEffect(() => {
    ...
    const id = window.setTimeout(() => setBodyReady(true), 50);
                        ...
                        <FormItem>
                          ...
                          <FormControl>
                            <SearchableSelect
                              ...
                              value={field.value || ""}
                              onValueChange={field.onChange}
                              onOpenChange={onCustomerSelectOpenChange}
