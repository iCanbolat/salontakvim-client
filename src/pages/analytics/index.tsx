...
export function Analytics() {
  const { state, actions, data } = useAnalytics();
  const { dateRange, activeTab, isExporting, isLoading, error } = state;
  const {
    appointmentData,
    revenueData,
    appointmentsByDate,
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <Select value={dateRange} onValueChange={actions.setDateRange}>
