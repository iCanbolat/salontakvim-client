...
import type { UpdateWidgetSettingsDto } from "@/types/widget.types";
                  ...
                  <Switch
                    checked={
                      settings.sidebarMenuItems[
                        item.key as keyof typeof settings.sidebarMenuItems
                      ]
                    }
                    onCheckedChange={(checked) =>
        ...
        <TabsContent value="typography" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Configure font and text sizing</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleUpdate("buttonBorderRadius", parseInt(e.target.value))
                  }
                  min={0}
                  max={24}
                  step={1}
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Display progress indicator in multi-step layout
                  </p>
                </div>
                <Switch
                  checked={settings.showProgressBar}
                  onCheckedChange={(checked) =>
                    handleUpdate("showProgressBar", checked)
                  }
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  value={settings.redirectUrlAfterBooking || ""}
                  onChange={(e) =>
                    handleUpdate("redirectUrlAfterBooking", e.target.value)
                  }
                />
                <p className="text-sm text-muted-foreground">
                  Optional: Redirect customers to a specific page after booking
                </p>
              </div>
            </CardContent>
          </Card>
